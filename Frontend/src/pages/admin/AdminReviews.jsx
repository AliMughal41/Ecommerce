...
import { Star, Plus, Pencil, Trash2, X, Loader2, GripVertical, ToggleLeft, ToggleRight } from 'lucide-react';
                    ...
                    <tbody>
                      {reviews.map((r, i) => (
                        <tr key={r._id} style={{ transition: 'background 0.2s', opacity: r.isActive ? 1 : 0.5 }}
                          ...
                          <td style={{ padding: '12px 14px', fontSize: '13px', borderBottom: '1px solid #1f1f1f' }}>{i + 1}</td>
